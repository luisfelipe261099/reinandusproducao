...
// Debug para verificar as condições que controlam a exibição do botão
error_log("DEBUG - Solicitação ID: " . $id);
error_log("DEBUG - Status: " . $solicitacao['status']);
error_log("DEBUG - Is Polo: " . ($is_polo ? 'Sim' : 'Não'));
error_log("DEBUG - Documento ID: " . ($solicitacao['documento_id'] ?? 'Não definido'));
error_log("DEBUG - Documento encontrado: " . ($documento ? 'Sim' : 'Não'));
