<?php
/**
 * Página de gerenciamento de declarações acadêmicas
 *
 * Esta página permite selecionar alunos e emitir declarações de matrícula
 * no formato PDF.
 */
       ...
       <div class="flex-1 flex flex-col overflow-hidden">
           ...
           <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
               <div class="container mx-auto">
                   ...
                   switch ($view) {
                       case 'selecionar_aluno':
                           include 'views/documentos/selecionar_aluno.php';
                           break;
                       case 'progresso':
                           include 'views/documentos/progresso.php';
                           break;
                       case 'listar':
                           include 'views/documentos/listar.php';
                           break;
                       case 'configuracoes':
