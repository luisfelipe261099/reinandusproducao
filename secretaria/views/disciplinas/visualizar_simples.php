<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    <div class="p-6">
        ...
        <!-- Informações do Professor - Removido pois a tabela não existe -->
        ...
        <div class="mt-8 flex flex-col sm:flex-row sm:justify-end space-y-3 sm:space-y-0 sm:space-x-3">
            <a href="disciplinas_simples.php?action=listar" class="btn-secondary">
                <i class="fas fa-arrow-left mr-2"></i> Voltar para a Lista
            </a>
            <a href="disciplinas_simples.php?action=editar&id=<?php echo $disciplina['id']; ?>" class="btn-primary">
