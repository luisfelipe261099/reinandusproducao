            ...
            <div class="bg-white shadow-md rounded-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-base font-medium"><?php echo ucfirst($chamado['subtipo']); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-base"><?php echo htmlspecialchars($chamado['aberto_por_nome'] ?? 'N/A'); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-base"><?php echo date('d/m/Y H:i', strtotime($chamado['data_atualizacao'])); ?></p>
                    </div>
                </div>
                
                <?php if (!empty($chamado['observacoes'])): ?>
                <div class="mt-4">
                    <p class="text-sm text-gray-500">Observações</p>
                    <p class="text-base"><?php echo nl2br(htmlspecialchars($chamado['observacoes'])); ?></p>
                </div>
                <?php endif; ?>
