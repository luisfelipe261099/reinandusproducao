...
<div class="mb-4 flex justify-between items-center">
    <a href="declaracoes.php" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded">
        <i class="fas fa-arrow-left mr-2"></i> Voltar
    </a>
    <div class="flex space-x-2">
        <a href="declaracoes.php?action=selecionar_aluno" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    <div class="p-6 border-b border-gray-200">
        <h3 class="text-xl font-semibold text-gray-800">Selecionar Alunos para Declarações de Matrícula</h3>
        <p class="text-gray-600 mt-1">Selecione os alunos para gerar declarações de matrícula em lote.</p>
    </div>
    <div class="p-6">
        <!-- Formulário de busca -->
        <form action="declaracoes.php" method="get" class="mb-6">
        ...
        <?php if (isset($alunos) && count($alunos) > 0): ?>
            <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-4">
                <h4 class="font-bold text-blue-800 mb-2">Instruções para geração de declarações:</h4>
                <ul class="list-disc pl-5 space-y-1">
                    <li>Selecione um ou mais alunos na lista abaixo</li>
                    <li>Clique em "Gerar Declarações" para processar os documentos</li>
                    <li>As declarações serão geradas em lotes para evitar sobrecarga do servidor</li>
            ...
            <form action="declaracoes.php" method="post" id="form-documentos-multiplos">
                ...
                <input type="hidden" name="tipo_documento" value="declaracao">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex justify-end space-x-2">
                        <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded text-sm">
                            <i class="fas fa-file-alt mr-1"></i> Gerar Declarações de Matrícula
                        </button>
                    </div>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php foreach ($alunos as $aluno): ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4 border-b">
                                        <div class="flex space-x-2">
                                            <a href="declaracoes.php?action=gerar_declaracao&aluno_id=<?php echo $aluno['id']; ?>" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm" title="Gerar Declaração de Matrícula">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    document.getElementById('form-documentos-multiplos').addEventListener('submit', function(e) {
                        ...
                        // Sempre será declaração nesta página
                        const tipoDocumentoTexto = 'declarações';
