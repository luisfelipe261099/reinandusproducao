<?php
/**
 * Página para testar diferentes valores para o campo tipo_boleto na API do Itaú
 */
...
$titulo_pagina = 'Testar Tipo de Boleto';
...
if ($action === 'testar') {
    ...
    if (empty($tipo_boleto)) {
        ...
        redirect('testar_tipo_boleto.php');
        exit;
    }
    ...
    try {
        ...
        $payload = [
            ...
            "dado_boleto" => [
                ...
                "sacador_avalista" => [
                    "cpf_cnpj_sacador_avalista" => "12345678909",
                    "nome_sacador_avalista" => "NOME DO SACADOR AVALISTA"
                ],
                "juros" => [
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <div class="container mx-auto">
                    ...
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <h2 class="text-xl font-bold mb-4">Testar Valores para o Campo tipo_boleto</h2>

                        <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700">
                            <p class="font-bold">Informação:</p>
                            <p>Esta ferramenta testa diferentes valores para o campo tipo_boleto na API do Itaú.</p>
                            <p class="mt-2">O erro 400 com a mensagem "Tipo de boleto inválido" indica que o valor usado não é aceito pela API.</p>
                        </div>

                        <form action="testar_tipo_boleto.php" method="get" class="mb-6">
