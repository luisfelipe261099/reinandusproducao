<?php
/**
 * Página para testar valores numéricos para o campo tipo_boleto na API do Itaú
 */
...
$titulo_pagina = 'Testar Tipo de Boleto Numérico';
$titulo_pagina_completo = 'Faciência ERP - ' . $titulo_pagina;

// Valores possíveis para o campo tipo_boleto
$tipos_boleto = [
    '1',
    '01',
    '2',
...
// Processa o teste
if ($action === 'testar') {
    // Obtém o tipo de boleto a ser testado
    $tipo_boleto = isset($_GET['tipo_boleto']) ? $_GET['tipo_boleto'] : '';
    
    if (empty($tipo_boleto)) {
        setMensagem('erro', 'É necessário selecionar um tipo de boleto para testar.');
        redirect('testar_tipo_boleto_numerico.php');
        exit;
    }
    ...
    try {
        ...
        $payload = [
            "data" => [
                ...
                "dado_boleto"             => [
                    ...
                    "tipo_boleto"           => $tipo_boleto, // Valor a ser testado
                    "codigo_carteira"       => "109",
                    ...
                    "dados_individuais_boleto" => [[
                        ...
                        "texto_uso_beneficiario" => "TESTE TIPO BOLETO",
        ...
        $resultados[] = [
            ...
            'status' => 'info',
            'mensagem' => 'Payload preparado com tipo_boleto = "' . $tipo_boleto . '"'
        ];
        ...
        if ($httpcode >= 200 && $httpcode < 300) {
            $resultados[] = [
                'etapa' => 'Chamada à API',
                'status' => 'sucesso',
                'mensagem' => 'Boleto gerado com sucesso usando tipo_boleto = "' . $tipo_boleto . '"'
            ];
            ...
            // Atualiza o arquivo processar_boleto.php
            $resultados[] = [
                'etapa' => 'Atualização do Código',
                'status' => 'sucesso',
                'mensagem' => "A função de geração de boletos foi atualizada para usar tipo_boleto = '$tipo_boleto'."
            ];
        } else {
            $resultados[] = [
                'etapa' => 'Chamada à API',
        ...
        $resultados[] = [
            'etapa' => 'Erro Geral',
            'status' => 'erro',
            'mensagem' => "Erro ao testar tipo de boleto: " . $e->getMessage()
        ];
    }
}
?>
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <div class="container mx-auto">
                    ...
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <h2 class="text-xl font-bold mb-4">Testar Valores Numéricos para o Campo tipo_boleto</h2>

                        <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700">
                            <p class="font-bold">Informação:</p>
                            <p>Esta ferramenta testa valores numéricos para o campo tipo_boleto na API do Itaú.</p>
                            <p class="mt-2">Segundo a documentação do Itaú, os valores válidos podem ser "1", "01" ou "A".</p>
                        </div>

                        <form action="testar_tipo_boleto_numerico.php" method="get" class="mb-6">
                            <input type="hidden" name="action" value="testar">
                            
                            <div class="mb-4">
                                <label for="tipo_boleto" class="block text-gray-700 font-bold mb-2">Selecione o Tipo de Boleto:</label>
                                <select id="tipo_boleto" name="tipo_boleto" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    <?php foreach ($tipos_boleto as $tipo): ?>
                            ...
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                <i class="fas fa-vial mr-2"></i> Testar Tipo de Boleto
                            </button>
                        </form>
