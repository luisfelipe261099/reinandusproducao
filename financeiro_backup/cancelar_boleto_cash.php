<?php
/**
 * Página para cancelar boletos via API cash_management do Itaú
 * Esta página usa a mesma API que foi usada para gerar o boleto
 */

// Inclui os arquivos necessários
require_once __DIR__ . '/../includes/init.php';
require_once __DIR__ . '/includes/cancelar_boleto_cash_management.php';
...
if ($action === 'confirmar') {
    $resultado = cancelarBoletoCashManagement($id, $db);
...
$titulo_pagina = 'Cancelar Boleto via API Cash Management';
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <div class="container mx-auto">
                    ...
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <h1 class="text-2xl font-bold mb-6 text-purple-800">Cancelar Boleto via API Cash Management</h1>

                        <div class="mb-6">
                            <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700">
                                <p class="font-bold">Informação:</p>
                                <p>Esta página usa a mesma API que foi usada para gerar o boleto (cash_management).</p>
                                <p class="mt-2">Isso garante maior compatibilidade e aumenta as chances de sucesso no cancelamento.</p>
                                <p class="mt-2">
                                    <strong>Ambiente atual:</strong> <?php echo ucfirst(obterConfiguracao('api_itau_ambiente', 'teste', $db)); ?>
                                </p>
                                <p>
                                    <strong>URL do token:</strong> <?php echo obterUrlTokenItau($db); ?>
                                </p>
                                <p>
                                    <strong>URL base da API:</strong> <?php echo obterUrlApiItau('cash_management', $db); ?>
                                </p>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="cancelar_boleto_cash.php?action=confirmar&id=<?php echo $id; ?>" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onclick="return confirm('Tem certeza que deseja cancelar este boleto?');">
                                    <i class="fas fa-times-circle mr-2"></i> Confirmar Cancelamento
                                </a>
