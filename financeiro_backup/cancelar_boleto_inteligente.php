<?php
/**
 * Página para cancelar boletos de forma inteligente, usando a mesma API que foi usada para gerar o boleto
 */

// Inclui os arquivos necessários
require_once __DIR__ . '/../includes/init.php';
require_once __DIR__ . '/includes/cancelar_boleto_inteligente.php';
...
if ($action === 'confirmar') {
    $resultado = cancelarBoletoInteligente($id, $db);
...
$titulo_pagina = 'Cancelar Boleto de Forma Inteligente';
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <div class="container mx-auto">
                    ...
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <h1 class="text-2xl font-bold mb-6 text-purple-800">Cancelar Boleto de Forma Inteligente</h1>

                        <div class="mb-6">
                            <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700">
                                <p class="font-bold">Informação:</p>
                                <p>Esta página cancela o boleto de forma inteligente, usando a mesma API que foi usada para gerar o boleto.</p>
                                <p class="mt-2">O sistema detectará automaticamente qual API foi usada e tentará cancelar o boleto usando a mesma API.</p>
                            </div>
                            ...
                            <div class="api-info-box">
                                ...
                                <div class="api-info-title mt-4">Estratégia de Cancelamento:</div>
                                <div class="api-info-value">
                                    <?php if ($api_tipo === 'cash_management'): ?>
                                    Tentará primeiro a API cash_management, depois a API de cobrança
                                    <?php elseif ($api_tipo === 'cobranca'): ?>
                                    Tentará primeiro a API de cobrança, depois a API cash_management
                                    <?php else: ?>
                                    Verificará qual API foi usada e tentará cancelar usando a mesma API
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="cancelar_boleto_inteligente.php?action=confirmar&id=<?php echo $id; ?>" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" onclick="return confirm('Tem certeza que deseja cancelar este boleto?');">
                                    <i class="fas fa-magic mr-2"></i> Cancelar de Forma Inteligente
                                </a>
