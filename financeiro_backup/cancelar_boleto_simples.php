<?php
/**
 * Página para cancelar boletos de forma simplificada, usando o mesmo formato que funcionou para a geração
 */

// Inclui os arquivos necessários
require_once __DIR__ . '/../includes/init.php';
require_once __DIR__ . '/includes/cancelar_boleto_simples.php';
...
if ($action === 'confirmar') {
    $resultado = cancelarBoletoSimples($id, $db);
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <div class="container mx-auto">
                    ...
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <h1 class="text-2xl font-bold mb-6 text-purple-800">Cancelar Boleto</h1>

                        <div class="mb-6">
                            <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700">
                                <p class="font-bold">Informação:</p>
                                <p>Esta página cancela o boleto usando o mesmo formato que funcionou para a geração.</p>
                                <p class="mt-2">O sistema enviará uma solicitação de cancelamento para a API do Itaú.</p>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="cancelar_boleto_simples.php?action=confirmar&id=<?php echo $id; ?>" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onclick="return confirm('Tem certeza que deseja cancelar este boleto?');">
