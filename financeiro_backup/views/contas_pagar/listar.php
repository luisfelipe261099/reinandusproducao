<div class="mb-6">
    <div class="flex justify-between items-center mb-4">
        <div>
            <a href="contas_pagar.php?action=nova" class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded inline-flex items-center">
                <i class="fas fa-plus mr-2"></i> Nova Conta a Pagar
            </a>
        </div>
        
        <div class="flex space-x-2">
            <a href="contas_pagar.php?status=pendente" class="<?php echo $status === 'pendente' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'; ?> hover:bg-blue-700 hover:text-white font-medium py-2 px-4 rounded">
                Pendentes
            </a>
            <a href="contas_pagar.php?status=pago" class="<?php echo $status === 'pago' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'; ?> hover:bg-blue-700 hover:text-white font-medium py-2 px-4 rounded">
                Pagas
            </a>
            <a href="contas_pagar.php?status=cancelado" class="<?php echo $status === 'cancelado' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'; ?> hover:bg-blue-700 hover:text-white font-medium py-2 px-4 rounded">
                Canceladas
            </a>
            <a href="contas_pagar.php?status=todos" class="<?php echo $status === 'todos' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'; ?> hover:bg-blue-700 hover:text-white font-medium py-2 px-4 rounded">
                Todas
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <form action="contas_pagar.php" method="get" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <input type="hidden" name="status" value="<?php echo htmlspecialchars($status); ?>">
            
            <div>
                <label for="termo" class="block text-sm font-medium text-gray-700 mb-1">Buscar</label>
                <input type="text" name="termo" id="termo" value="<?php echo htmlspecialchars($filtros['termo'] ?? ''); ?>" placeholder="Descrição, fornecedor..." class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
            </div>
            ...
            <div class="md:col-span-3 flex justify-end space-x-2">
                ...
                <a href="contas_pagar.php?status=<?php echo htmlspecialchars($status); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-4 rounded">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 card">
            <h3 class="text-sm font-medium text-gray-500 mb-2">Valor total a pagar</h3>
            <?php
            $valor_total = 0;
            ...
            ?>
            <p class="text-2xl font-bold text-red-600">R$ <?php echo number_format($valor_total, 2, ',', '.'); ?></p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-6 text-center text-gray-500">
            ...
            <p class="mt-2">
                <a href="contas_pagar.php?action=nova" class="text-blue-600 hover:text-blue-800">
                    <i class="fas fa-plus mr-1"></i> Adicionar Conta a Pagar
                </a>
            </p>
        </div>
        <?php else: ?>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="contas_pagar.php?action=visualizar&id=<?php echo $conta['id']; ?>" class="text-blue-600 hover:text-blue-900 mr-3">
                                <i class="fas fa-eye"></i>
                            </a>
                            
                            <?php if ($conta['status'] === 'pendente'): ?>
                            <a href="contas_pagar.php?action=pagar&id=<?php echo $conta['id']; ?>" class="text-green-600 hover:text-green-900 mr-3">
                                <i class="fas fa-money-bill-wave"></i>
                            </a>
                            <?php endif; ?>
                            
                            <a href="contas_pagar.php?action=editar&id=<?php echo $conta['id']; ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-1">
                    <?php if ($pagina > 1): ?>
                    <a href="contas_pagar.php?pagina=1<?php echo http_build_query(array_merge($filtros, ['status' => $status])); ?>" class="px-3 py-1 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300">
                        <i class="fas fa-angle-double-left"></i>
                    </a>
                    <a href="contas_pagar.php?pagina=<?php echo $pagina - 1; ?>&<?php echo http_build_query(array_merge($filtros, ['status' => $status])); ?>" class="px-3 py-1 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300">
                    ...
                    ?>
                    <a href="contas_pagar.php?pagina=<?php echo $i; ?>&<?php echo http_build_query(array_merge($filtros, ['status' => $status])); ?>" class="px-3 py-1 rounded-md <?php echo $i === $pagina ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'; ?>">
                        <?php echo $i; ?>
                    </a>
                    <?php endfor; ?>
                    ...
                    <a href="contas_pagar.php?pagina=<?php echo $total_paginas; ?>&<?php echo http_build_query(array_merge($filtros, ['status' => $status])); ?>" class="px-3 py-1 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300">
