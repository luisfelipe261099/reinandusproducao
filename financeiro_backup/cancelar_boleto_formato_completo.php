<?php
/**
 * Página para cancelar boletos usando o formato completo do nosso número (com carteira e dígito verificador)
 */

// Inclui os arquivos necessários
require_once __DIR__ . '/../includes/init.php';
require_once __DIR__ . '/includes/cancelar_boleto_formato_completo.php';
...
if ($action === 'confirmar') {
    $resultado = cancelarBoletoFormatoCompleto($id, $db);
...
$titulo_pagina = 'Cancelar Boleto (Formato Completo)';
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <div class="container mx-auto">
                    ...
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <h1 class="text-2xl font-bold mb-6 text-purple-800">Cancelar Boleto (Formato Completo)</h1>

                        <div class="mb-6">
                            <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700">
                                <p class="font-bold">Informação:</p>
                                <p>Esta página cancela o boleto usando o formato completo do nosso número (com carteira e dígito verificador).</p>
                                <p class="mt-2">Este método é diferente dos anteriores e pode funcionar quando os outros falham.</p>
                            </div>
                            ...
                            <div class="api-info-box">
                                ...
                                <div class="api-info-value">API de Baixa com Formato Completo</div>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="cancelar_boleto_formato_completo.php?action=confirmar&id=<?php echo $id; ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded" onclick="return confirm('Tem certeza que deseja cancelar este boleto usando o formato completo do nosso número?');">
                                    <i class="fas fa-ban mr-2"></i> Cancelar (Formato Completo)
                                </a>
