<?php
/**
 * Página para testar o valor "01" para o campo tipo_boleto na API do Itaú
 */
...
$titulo_pagina = 'Testar Tipo de Boleto "01"';
...
if ($action === 'testar') {
    try {
        ...
        // Preparar payload para teste com tipo_boleto = "01"
        $payload = [
            "id_lote" => "1",
            "tipo_ambiente" => "1",
            "tipo_registro" => "1",
            ...
            "dado_boleto" => [
                ...
                "tipo_boleto" => "01", // Testando o valor "01"
                "codigo_carteira" => "109",
        ...
        $resultados[] = [
            ...
            'status' => 'info',
            'mensagem' => 'Payload preparado com tipo_boleto = "01"'
        ];
        ...
        if ($httpcode >= 200 && $httpcode < 300) {
            $resultados[] = [
                'etapa' => 'Chamada à API',
                'status' => 'sucesso',
                'mensagem' => 'Boleto gerado com sucesso usando tipo_boleto = "01"'
            ];
            ...
            // Atualiza a função de geração de boletos para usar tipo_boleto = "01"
            try {
                $db->query("INSERT INTO configuracoes (chave, valor, descricao) VALUES ('tipo_boleto_valido', '01', 'Tipo de boleto válido para a API do Itaú') ON DUPLICATE KEY UPDATE valor = '01'", []);
                
                $resultados[] = [
                    'etapa' => 'Configuração',
                    'status' => 'sucesso',
                    'mensagem' => "Tipo de boleto '01' salvo como válido na tabela de configurações."
                ];
            } catch (Exception $e) {
                $resultados[] = [
                    'etapa' => 'Configuração',
            ...
            $resultados[] = [
                ...
                'status' => 'sucesso',
                'mensagem' => "A função de geração de boletos foi atualizada para usar tipo_boleto = '01'."
            ];
        } else {
            $resultados[] = [
                'etapa' => 'Chamada à API',
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <div class="container mx-auto">
                    ...
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <h2 class="text-xl font-bold mb-4">Testar Valor "01" para o Campo tipo_boleto</h2>

                        <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700">
                            <p class="font-bold">Informação:</p>
                            <p>Esta ferramenta testa o valor "01" para o campo tipo_boleto na API do Itaú.</p>
...
"dado_boleto": {
  "descricao_instrumento_cobranca": "boleto",
  "tipo_boleto": "01",  // Testando este valor
  "codigo_carteira": "109",
  ...
}
                        </div>

                        <form action="testar_tipo_boleto_01.php" method="get" class="mb-6">
                            <input type="hidden" name="action" value="testar">
                            
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                <i class="fas fa-vial mr-2"></i> Testar Tipo de Boleto "01"
                            </button>
                        </form>
