<?php
/**
 * Setup Simplificado do Módulo Financeiro
 * Versão sem foreign keys para evitar problemas de compatibilidade
 */
...
if ($_POST['action'] ?? '' === 'configurar') {
    try {
        ...
        // Verifica se a coluna descricao existe na tabela
        $colunas = $db->fetchAll("SHOW COLUMNS FROM categorias_financeiras");
        $temDescricao = false;
        foreach ($colunas as $coluna) {
            if ($coluna['Field'] === 'descricao') {
                $temDescricao = true;
                break;
            }
        }
        ...
        $mensagens[] = 'Categorias padrão inseridas.';
...
$pageTitle = 'Configuração Simplificada do Módulo Financeiro';
?>
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Versão sem foreign keys para máxima compatibilidade
                </p>
            </div>
            ...
            <form class="mt-8 space-y-6" method="POST">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Configuração Simplificada:</h3>
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-center">
                            <i class="fas fa-check text-green-500 mr-2"></i>
                            9 tabelas principais sem foreign keys
                        </li>
                        <li class="flex items-center">
                            <i class="fas fa-check text-green-500 mr-2"></i>
                        ...
                        <li class="flex items-center">
                            <i class="fas fa-check text-green-500 mr-2"></i>
                            Máxima compatibilidade com MySQL
                        </li>
                    </ul>
                </div>
