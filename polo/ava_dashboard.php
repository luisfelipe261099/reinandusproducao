            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <div class="container mx-auto">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="ava_cursos.php" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2">
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
                                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                                    ...
                                    <a href="ava_cursos.php" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">
                                        ...
                                        <div class="curso-card">
                                            ...
                                            <div class="curso-body">
                                                ...
                                                <div class="curso-footer">
                                                    ...
                                                    <a href="ava_curso_editar.php?id=<?php echo $curso['id']; ?>" class="inline-flex items-center px-3 py-1.5 bg-indigo-100 text-indigo-800 text-xs font-medium rounded hover:bg-indigo-200">
                        ...
                        <div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                                ...
                                <div class="p-6">
                                    <div class="space-y-4">
                                        <a href="ava_cursos_novo.php" class="flex items-center p-3 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
                                        ...
                                        <a href="ava_alunos.php" class="flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                                        ...
                                        <a href="ava_relatorios.php" class="flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                                        ...
                                        <a href="ava_ajuda.php" class="flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
