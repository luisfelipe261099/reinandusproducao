        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <div class="container mx-auto">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="../uploads/documentos_alunos/<?php echo $documento['arquivo']; ?>" target="_blank" class="text-blue-600 hover:text-blue-900 mr-3">Visualizar</a>
                                                <?php if ($documento['status'] === 'rejeitado'): ?>
                                                <a href="alunos_documentos.php?action=upload&id=<?php echo $aluno_id; ?>&tipo=<?php echo $documento['tipo_documento_id']; ?>" class="text-green-600 hover:text-green-900">Reenviar</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                    ...
                    <div class="mt-6">
                        <a href="alunos.php" class="btn-secondary">Voltar para a Lista de Alunos</a>
                    </div>
                </div>
            </main>
