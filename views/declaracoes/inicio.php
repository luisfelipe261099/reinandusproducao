...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
        <div class="p-6 text-center">
            ...
            <a href="declaracoes.php?action=selecionar_aluno" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded transition-colors duration-300">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
        <div class="p-6 text-center">
            ...
            <a href="declaracoes.php?action=listar" class="inline-block bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded transition-colors duration-300">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
        <div class="p-6 text-center">
            ...
            <a href="declaracoes.php?action=configuracoes" class="inline-block bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded transition-colors duration-300">
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 border-b">
                        <div class="flex space-x-2">
                            <a href="declaracoes.php?action=visualizar&id=<?php echo $doc['id']; ?>" class="text-blue-500 hover:text-blue-700" title="Visualizar">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="declaracoes.php?action=download&id=<?php echo $doc['id']; ?>" class="text-green-500 hover:text-green-700" title="Download">
    ...
    <div class="p-4 bg-gray-50 border-t border-gray-200 text-right">
        <a href="declaracoes.php?action=listar" class="text-blue-500 hover:text-blue-700">
            <i class="fas fa-list mr-1"></i> Ver todas as declarações
        </a>
    </div>
</div>