...
<div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
    <div class="p-6 border-b border-gray-200 flex justify-between items-center">
        <h3 class="text-xl font-semibold text-gray-800">Documentos Emitidos</h3>
        <div class="flex space-x-2">
            <a href="documentos.php?action=baixar_em_lote" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm">
                <i class="fas fa-download mr-2"></i> Baixar Documentos em Lote
            </a>
    ...
    <div class="p-6 border-b border-gray-200 bg-gray-50">
        <form action="documentos.php" method="get" class="space-y-4">
            ...
            <div class="flex justify-end space-x-2">
                ...
                <a href="documentos.php?action=listar" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm">
