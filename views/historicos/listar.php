...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    ...
    // Apenas históricos (tipo_documento_id = 1)
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
    <div class="p-6 border-b border-gray-200 flex justify-between items-center">
        <h3 class="text-xl font-semibold text-gray-800">Históricos Emitidos</h3>
        <div class="flex space-x-2">
            <a href="historico.php?action=baixar_em_lote" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm">
                <i class="fas fa-download mr-2"></i> Baixar Históricos em Lote
            </a>
            <a href="historico.php?action=selecionar_aluno" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm">
                <i class="fas fa-plus mr-2"></i> Emitir Novo Histórico
            </a>
        </div>
    </div>
    ...
    <div class="p-6 border-b border-gray-200 bg-gray-50">
        <form action="historico.php" method="get" class="space-y-4">
            ...
            <div class="flex justify-end space-x-2">
                ...
                <a href="historico.php?action=listar" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm">
    ...
    // Filtro fixo para mostrar apenas históricos (tipo_documento_id = 1)
    ...
    if (!empty($_GET['filtro_tipo']) && $_GET['filtro_tipo'] == 1) {
        // Já está filtrado para históricos, não precisa adicionar novamente
    }
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end space-x-3">
                            <?php if (!empty($doc['id'])): ?>
                            <a href="historico.php?action=visualizar&id=<?php echo $doc['id']; ?>" class="text-blue-600 hover:text-blue-900" title="Visualizar">
                                <i class="fas fa-eye"></i>
                            </a>
                            <?php if (!empty($doc['arquivo'])): ?>
                            <a href="historico.php?action=download&id=<?php echo $doc['id']; ?>" class="text-green-600 hover:text-green-900" title="Download">
    ...
    <div class="p-6 text-center">
        <div class="py-12">
            ...
            <div class="flex justify-center space-x-4">
                ...
                <a href="historico.php?action=listar" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg text-sm">
